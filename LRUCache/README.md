This is taken from Hacker Rank. My original implementation was using a non-circular bi-directional linked list. Initial solution works, but takes too long.
